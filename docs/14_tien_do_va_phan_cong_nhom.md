...
| CSDL-VH-01 | Kiểm tra migration chạy lại an toàn | Thành viên 2 | Thành viên 3 | Hoàn thành | `bash scripts/test_migrations.sh` pass |
...
| Chuẩn bị câu trả lời về backup, RLS, index, benchmark | Thành viên 2 + Thành viên 3 | Trung bình | Dùng `docs/05`, `docs/06`, `docs/07` |
